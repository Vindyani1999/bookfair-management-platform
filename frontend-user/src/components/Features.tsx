  ...
  const features = [
    {
      ...
      description: 'Explore available stalls through our real-time interactive map. Choose from small, medium, or large stalls and reserve up to 3 stalls per business with instant visual feedback.',
      color: 'from-amber-600 to-orange-600'
    },
    {
      icon: CheckCircle,
      title: 'Instant Confirmation',
      description: 'Receive immediate email confirmation with your unique QR code pass. Simply download and present at the exhibition entrance for hassle-free access.',
      color: 'from-orange-600 to-red-600'
    },
    {
      icon: Calendar,
      title: 'Easy Management',
      description: 'Manage all your reservations from one dashboard. Add literary genres, track bookings, and update your exhibition details effortlessly throughout the event.',
    ...
    <section id="features" className="py-24 px-6 bg-">
      <div className="container mx-auto">
        ...
        <p className="text-xl text-gray-600 text-center mb-16 max-w-2xl mx-auto">
          Experience seamless stall booking with cutting-edge features designed for publishers
        </p>
