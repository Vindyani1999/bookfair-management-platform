...
export default function UserProfileForm() {
    ...
    const [passwordFlowStep, setPasswordFlowStep] = useState<"initial" | "otp" | "newpass">("initial");
    ...
    const handleVerifyOTP = async () => {
        ...
        try {
            ...
            setPasswordError(err.response?.data?.message || "Invalid or expired OTP. Please try again.");
        } finally {
            setPasswordLoading(false);
        }
    };
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-12 pr-4 py-3 bg-white/60 border rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all ${getFieldError("fullName")
                            ...
                            {getFieldError("fullName") && (
                                <p className="mt-1 text-xs text-red-600">{getFieldError("fullName")}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-12 pr-4 py-3 bg-white/60 border rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all ${getFieldError("contactNumber")
                                            ? "border-red-300 focus:ring-red-200"
                                            : "border-slate-300 focus:ring-slate-200"
                                        }`}
                            ...
                            {getFieldError("contactNumber") && (
                                <p className="mt-1 text-xs text-red-600">{getFieldError("contactNumber")}</p>
                            )}
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-3 bg-white/60 border rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all ${getFieldError("email")
                                        ? "border-red-300 focus:ring-red-200"
                                        : "border-slate-300 focus:ring-slate-200"
                                    }`}
                    ...
                    {showPasswordFlow && (
                        <div className="space-y-4 bg-slate-50 rounded-xl p-4 border border-slate-200">
                            <div className="flex items-center justify-center gap-2 mb-4">
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm ${passwordFlowStep === "initial" || passwordFlowStep === "otp" || passwordFlowStep === "newpass" ? "bg-slate-900 text-white" : "bg-slate-300 text-slate-600"}`}>
                                    {passwordFlowStep === "initial" || passwordFlowStep === "otp" || passwordFlowStep === "newpass" ? "1" : "✓"}
                                </div>
                                <div className={`w-8 h-1 ${passwordFlowStep === "otp" || passwordFlowStep === "newpass" ? "bg-slate-900" : "bg-slate-300"}`}></div>
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm ${passwordFlowStep === "otp" || passwordFlowStep === "newpass" ? "bg-slate-900 text-white" : "bg-slate-300 text-slate-600"}`}>
                                    {passwordFlowStep === "newpass" ? "3" : "2"}
                                </div>
                                <div className={`w-8 h-1 ${passwordFlowStep === "newpass" ? "bg-slate-900" : "bg-slate-300"}`}></div>
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm ${passwordFlowStep === "newpass" ? "bg-slate-900 text-white" : "bg-slate-300 text-slate-600"}`}>
                                    3
                                </div>
                            </div>
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 flex gap-3">
                                        ...
                                        <div className="text-sm text-blue-800">
                                            ...
                                            <p className="text-xs text-blue-700">
                                                We'll send an OTP to verify your email, then you can set a new password.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {(newPassword || confirmPassword) && (
                                        <div className="text-xs space-y-1 bg-white rounded-lg p-3 border border-slate-200">
                                            <p className={newPassword.length >= 6 ? 'text-green-600 font-medium flex items-center gap-1' : 'text-slate-500 flex items-center gap-1'}>
                                                {newPassword.length >= 6 ? <Check className="w-3 h-3" /> : <AlertCircle className="w-3 h-3" />}
                                                At least 6 characters
                                            </p>
                                            <p className={newPassword === confirmPassword && newPassword.length > 0 ? 'text-green-600 font-medium flex items-center gap-1' : 'text-slate-500 flex items-center gap-1'}>
                                                {newPassword === confirmPassword && newPassword.length > 0 ? <Check className="w-3 h-3" /> : <AlertCircle className="w-3 h-3" />}
                                                Passwords match
                                            </p>
                                        </div>
                                    )}
